-- SNOWBALL DATABASE SCHEMA
-- Complete schema for investor and founder dashboard templates

-- PAGE TEMPLATES TABLE
-- Stores customizable dashboard templates for different audiences
...
-- Links with custom welcome messages and template references
...
-- Simple founder update posts for demo purposes
...
CREATE POLICY "Allow all operations" ON referral_links FOR ALL USING (true);
CREATE POLICY "Allow all operations" ON page_templates FOR ALL USING (true);
CREATE POLICY "Allow all operations" ON monthly_updates FOR ALL USING (true);
