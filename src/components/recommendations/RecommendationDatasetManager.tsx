...
interface RecommendationDatasetManagerProps {
...
export function RecommendationDatasetManager({ onSelectDataset }: RecommendationDatasetManagerProps) {
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Manage datasets stored in Google Cloud Storage for AI recommendations and BigQuery analytics
              </CardDescription>
            </div>
            <Button
        ...
        <Card>
          <CardContent className="text-center py-12">
            ...
            <p className="text-gray-500 mb-6">
              Upload your first dataset to get started with AI recommendations and BigQuery analytics.
            </p>
          </CardContent>
        </Card>
      )}
